...
export class StartWorkoutService {
  ...
  saveActiveWorkout (param: any): Observable<Workout[]> {
    let body = JSON.stringify(param); // Stringify payload
    return this.http.post('http://localhost:8090/workouttracker/setactiveworkout', body, this.options) // ...using post request
